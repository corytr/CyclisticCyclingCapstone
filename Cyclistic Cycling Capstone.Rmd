---
title: "Cyclistic Cycling Capstone"
author: "Cory Reidenouer"
date: "2023-10-17"
...
setwd("/Users/coryreidenouer/Desktop/Capstone") #sets your working directory to simplify calls to data
```
...
write.csv(counts, file = '~/Desktop/Capstone/avg_ride_length.csv')
```
